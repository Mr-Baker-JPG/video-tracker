...
const clientDir = path.join(process.cwd(), 'node_modules/@prisma/client/.prisma/client');
...
if (fs.existsSync(clientDir)) {
	...
	fs.writeFileSync(defaultJs, "const c=require('./client.ts');module.exports=c;");
...
if (fs.existsSync(runtimeDir)) {
	...
	fs.writeFileSync(libraryMjs, "export{makeTypedQueryFactory}from'./client.mjs';");
}
